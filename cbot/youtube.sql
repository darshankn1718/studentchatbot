...
(1, 'hi||||Hello||hello||Hola', 'Hello, welcome to Dayananda Sagar. How can I help you.'),
(2, 'how are you', 'I am Fine. How can I help you?'),
(3, 'about college', 'Dayananda Sagar College of Engineering is an autonomous engineering college in Bengaluru, Karnataka. It is affiliated to Visvesvaraya Technological University, Belagavi. For more info visit: https://www.dsce.edu.in/about/about-us'),
(4, 'what is your name||whats your name', 'My name is JAI Bot. Developed by Darshan kn and Dhanush'),
(5, 'what should i call you', 'You can call me JAI'),
(6, 'Where are your from', 'I m from Dayananda Sagar College'),
(7, 'bye||see you later||have a Good Day', 'Sad to see you are going. Have a nice day'),
(8, 'thank you||thanks', 'Anytime'),
(9, 'Ok', 'Do you have any other Questions?'),
(10, 'No', 'Ok. Have a Good Day.');
-- --------------------------------------------------------
